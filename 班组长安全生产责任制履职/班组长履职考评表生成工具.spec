...
"""PyInstaller 打包配置：班组长履职考评表生成工具（兼容 Windows 7 SP1 ~ Windows 11）
...
- 目标位数：默认 x64；构建 32 位版本时设置环境变量：
    $env:PYI_BITS=32; $env:PYI_EXE_NAME="班组长履职考评表生成工具_win32"
...
EXE_NAME = os.environ.get("PYI_EXE_NAME", "班组长履职考评表生成工具")
